...
public class PhotoCaptureHandler : MonoBehaviour
{
    ...
    void TakePicture()
    {
        ...
        string filename = string.Format(@"MyCapturedImage{0}.jpg", capturedImageCount);
        string filePath = System.IO.Path.Combine("C:/Data/Users/**please add your user mail adress**/Pictures/Saved Pictures", filename);
        //string filePath = System.IO.Path.Combine("C:/Users/shoutr labs/Videos/Captures", filename);
